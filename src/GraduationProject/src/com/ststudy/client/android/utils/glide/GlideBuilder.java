...
import com.ststudy.client.android.utils.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import com.ststudy.client.android.utils.glide.load.engine.bitmap_recycle.LruArrayPool;
import com.ststudy.client.android.utils.glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.ststudy.client.android.utils.glide.load.engine.cache.DiskCache;
import com.ststudy.client.android.utils.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.ststudy.client.android.utils.glide.load.engine.cache.LruResourceCache;
import com.ststudy.client.android.utils.glide.load.engine.cache.MemoryCache;
import com.ststudy.client.android.utils.glide.load.engine.cache.MemorySizeCalculator;
import com.ststudy.client.android.utils.glide.load.engine.executor.GlideExecutor;
import com.ststudy.client.android.utils.glide.manager.ConnectivityMonitorFactory;
import com.ststudy.client.android.utils.glide.manager.DefaultConnectivityMonitorFactory;
...
public final class GlideBuilder {
  ...
  /**
   * Sets the {@link com.ststudy.client.android.utils.glide.load.engine.bitmap_recycle.BitmapPool} implementation to use
  ...
  /**
   * Sets the {@link com.ststudy.client.android.utils.glide.load.engine.cache.MemoryCache} implementation to store
   * {@link com.ststudy.client.android.utils.glide.load.engine.Resource}s that are not currently in use.
   *
  ...
  /**
   * Sets the {@link com.ststudy.client.android.utils.glide.load.engine.cache.DiskCache} implementation to use to store
   * {@link com.ststudy.client.android.utils.glide.load.engine.Resource} data and thumbnails.
   *
   ...
   * use {@link #setDiskCache(com.ststudy.client.android.utils.glide.load.engine.cache.DiskCache.Factory)} instead.
  ...
  /**
   * Sets the {@link com.ststudy.client.android.utils.glide.load.engine.cache.DiskCache.Factory} implementation to use
   * to construct the {@link com.ststudy.client.android.utils.glide.load.engine.cache.DiskCache} to use to store {@link
   * com.ststudy.client.android.utils.glide.load.engine.Resource} data on disk.
   *
   ...
   * {@link com.ststudy.client.android.utils.glide.load.engine.Resource}s that are not already in the cache.
   *
   * <p> Any implementation must order requests based on their {@link com.ststudy.client.android.utils.glide.Priority}
  ...
  /**
   * Sets the {@link java.util.concurrent.ExecutorService} implementation to use when retrieving
   * {@link com.ststudy.client.android.utils.glide.load.engine.Resource}s that are currently in cache.
   *
   * <p> Any implementation must order requests based on their {@link com.ststudy.client.android.utils.glide.Priority}
   * for thumbnail requests to work properly.
   *
   ...
   * RequestBuilder#apply(com.ststudy.client.android.utils.glide.request.BaseRequestOptions)} will override defaults
   * set here.
   *
  ...
  /**
   * Sets the {@link com.ststudy.client.android.utils.glide.load.DecodeFormat} that will be the default format for all
   ...
   * com.ststudy.client.android.utils.glide.load.DecodeFormat} for more details. </p>
   *
  ...
  /**
   * Sets the {@link com.ststudy.client.android.utils.glide.manager.ConnectivityMonitorFactory}
   * to use to notify {@link com.ststudy.client.android.utils.glide.RequestManager} of connectivity events.
   * If not set {@link com.ststudy.client.android.utils.glide.manager.DefaultConnectivityMonitorFactory} would be used.
   *

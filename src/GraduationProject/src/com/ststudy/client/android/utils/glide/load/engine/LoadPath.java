...
/**
 * For a given {@link com.ststudy.client.android.utils.glide.load.data.DataFetcher} for a given data class, attempts to
 * fetch the data and then run it through one or more
 * {@link com.ststudy.client.android.utils.glide.load.engine.DecodePath}s.
 *

...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback,
   ...
   * @param bitmapPool          A {@link com.ststudy.client.android.utils.glide.load.engine.bitmap_recycle.BitmapPool}
   *                            that can be used to return the first frame when this drawable is
   *                            recycled.
   * @param frameTransformation An {@link com.ststudy.client.android.utils.glide.load.Transformation} that can be
   ...
   * @see #setFrameTransformation(com.ststudy.client.android.utils.glide.load.Transformation, android.graphics.Bitmap)
   */

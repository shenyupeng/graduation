 ...
 * {@link android.graphics.Bitmap}s returned by {@link com.ststudy.client.android.utils.glide.load.ResourceDecoder}s.
 *
 * <p> Note - In some cases it may not be possible to obey the requested setting, not all
 * {@link com.ststudy.client.android.utils.glide.load.resource.bitmap.Downsampler}s support setting formats and certain

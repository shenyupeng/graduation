...
public class CrashHandlerUtils implements UncaughtExceptionHandler {
    public static final String TAG = CrashHandlerUtils.class.getSimpleName();

    private static CrashHandlerUtils instance = null;
    ...
    private CrashHandlerUtils(Context context) {
        mContext = context;
        mDefaultHandler = Thread.getDefaultUncaughtExceptionHandler();
        Thread.setDefaultUncaughtExceptionHandler(this);
    }

    public static CrashHandlerUtils getInstance(Context context) {
        if (instance == null) {
            synchronized (CrashHandlerUtils.class) {
                if (instance == null) {
                    instance = new CrashHandlerUtils(context);
                }
            }
        }
        return instance;
    ...
    private void saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                String path = "/sdcard/graduation/log/";

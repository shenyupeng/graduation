...
import com.ststudy.client.android.utils.glide.load.data.DataRewinder;
import com.ststudy.client.android.utils.glide.load.data.DataRewinderRegistry;
import com.ststudy.client.android.utils.glide.load.engine.DecodePath;
import com.ststudy.client.android.utils.glide.load.engine.LoadPath;
...
import com.ststudy.client.android.utils.glide.load.model.ModelLoaderRegistry;
import com.ststudy.client.android.utils.glide.load.resource.transcode.ResourceTranscoder;
import com.ststudy.client.android.utils.glide.load.resource.transcode.TranscoderRegistry;
import com.ststudy.client.android.utils.glide.provider.EncoderRegistry;
import com.ststudy.client.android.utils.glide.provider.LoadPathCache;
import com.ststudy.client.android.utils.glide.provider.ModelToResourceClassCache;
import com.ststudy.client.android.utils.glide.provider.ResourceDecoderRegistry;
import com.ststudy.client.android.utils.glide.provider.ResourceEncoderRegistry;
...
public class Registry {
  ...
  /**
   * Use the given factory to build a {@link com.ststudy.client.android.utils.glide.load.model.ModelLoader} for models
  ...
  /**
   * Thrown when no {@link com.ststudy.client.android.utils.glide.load.model.ModelLoader} is registered for a given
   * model class.
   */

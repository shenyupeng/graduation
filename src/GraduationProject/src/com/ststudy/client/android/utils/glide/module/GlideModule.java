package com.ststudy.client.android.utils.glide.module;

import com.ststudy.client.android.utils.glide.GlideBuilder;
import com.ststudy.client.android.utils.glide.Registry;

import android.content.Context;

/**
 * An interface allowing lazy configuration of Glide including setting options using
 * {@link com.ststudy.client.android.utils.glide.GlideBuilder} and registering
 * {@link com.ststudy.client.android.utils.glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, com.ststudy.client.android.utils.glide.load.ResourceDecoder)} for each
 * {@link com.ststudy.client.android.utils.glide.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
...
public interface GlideModule {
  ...
  /**
   * Lazily apply options to a {@link com.ststudy.client.android.utils.glide.GlideBuilder} immediately before the Glide
   * singleton is created.
   *
   * <p> This method will be called once and only once per implementation. </p>
   *
   * @param context An Application {@link android.content.Context}.
   * @param builder The {@link com.ststudy.client.android.utils.glide.GlideBuilder} that will be used to create Glide.
   */
   ...
   *
   * @param context  An Application {@link android.content.Context}.
   * @param registry An {@link com.ststudy.client.android.utils.glide.Registry} to use to register components.
   */

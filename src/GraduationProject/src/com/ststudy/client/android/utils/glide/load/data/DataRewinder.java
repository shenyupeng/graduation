...
public interface DataRewinder<T> {
   ...
   * {@link com.ststudy.client.android.utils.glide.load.data.DataRewinder}s.
   *
   * @param <T> The type of data that the {@link com.ststudy.client.android.utils.glide.load.data.DataRewinder} will
   *            wrap.
   */
  interface Factory<T> {
    /**
     * Returns a new {@link com.ststudy.client.android.utils.glide.load.data.DataRewinder} wrapping the given data.
     */
    DataRewinder<T> build(T data);

    /**
     * Returns the class of data this factory can produce
     * {@link com.ststudy.client.android.utils.glide.load.data.DataRewinder}s for.
     */

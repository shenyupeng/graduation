...
import com.ststudy.client.android.utils.glide.request.transition.NoTransition;
import com.ststudy.client.android.utils.glide.request.transition.TransitionFactory;
import com.ststudy.client.android.utils.glide.request.transition.ViewAnimationFactory;
import com.ststudy.client.android.utils.glide.request.transition.ViewPropertyAnimationFactory;
import com.ststudy.client.android.utils.glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   *
   * @param animator The {@link com.ststudy.client.android.utils.glide.request.transition.ViewPropertyTransition
   *                 .Animator} to run.
   * @return This request builder.
   */

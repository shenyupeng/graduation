package com.ststudy.client.android.utils.glide.provider;

import android.support.annotation.Nullable;
import android.support.v4.util.ArrayMap;

import com.ststudy.client.android.utils.glide.load.engine.LoadPath;
import com.ststudy.client.android.utils.glide.util.MultiClassKey;

import java.util.concurrent.atomic.AtomicReference;

/**
 * Maintains a cache of data, resource, and transcode classes to available
 * {@link com.ststudy.client.android.utils.glide.load.engine.LoadPath}s capable of decoding with the requested types.
 */

...
import com.ststudy.client.android.utils.glide.load.engine.DiskCacheStrategy;
import com.ststudy.client.android.utils.glide.load.resource.bitmap.BitmapDrawableTransformation;
import com.ststudy.client.android.utils.glide.load.resource.bitmap.BitmapEncoder;
import com.ststudy.client.android.utils.glide.load.resource.bitmap.CenterCrop;
import com.ststudy.client.android.utils.glide.load.resource.bitmap.CenterInside;
import com.ststudy.client.android.utils.glide.load.resource.bitmap.CircleCrop;
import com.ststudy.client.android.utils.glide.load.resource.bitmap.DownsampleStrategy;
import com.ststudy.client.android.utils.glide.load.resource.bitmap.Downsampler;
import com.ststudy.client.android.utils.glide.load.resource.bitmap.FitCenter;
...
import com.ststudy.client.android.utils.glide.load.resource.gif.GifDrawableTransformation;
import com.ststudy.client.android.utils.glide.load.resource.gif.StreamGifDecoder;
import com.ststudy.client.android.utils.glide.signature.EmptySignature;
...
public abstract class BaseRequestOptions<CHILD extends BaseRequestOptions<CHILD>>
  ...
  /**
   * Applies a multiplier to the {@link com.ststudy.client.android.utils.glide.request.target.Target}'s size before
   ...
   *                       {@link com.ststudy.client.android.utils.glide.request.target.Target}'s dimensions when
  ...
  /**
   * Sets the {@link com.ststudy.client.android.utils.glide.load.engine.DiskCacheStrategy} to use for this load.
   *
   * <p> Defaults to {@link com.ststudy.client.android.utils.glide.load.engine.DiskCacheStrategy#AUTOMATIC}. </p>
   *
   * <p> For most applications {@link com.ststudy.client.android.utils.glide.load.engine.DiskCacheStrategy#RESOURCE} is
   ...
   * using {@link com.ststudy.client.android.utils.glide.load.engine.DiskCacheStrategy#DATA} or
   * {@link com.ststudy.client.android.utils.glide.load.engine.DiskCacheStrategy#ALL}. </p>
   *
   ...
   * {@link com.ststudy.client.android.utils.glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.ststudy.client.android.utils.glide.request.target.Target}'s width and height with the
   ...
   *
   * @param signature A unique non-null {@link com.ststudy.client.android.utils.glide.load.Key} representing the current
   *                  state of the model that will be mixed in to the cache key.
   * @return This request builder.
   * @see com.ststudy.client.android.utils.glide.signature.StringSignature
   */
   ...
   * {@link com.ststudy.client.android.utils.glide.load.resource.bitmap.BitmapEncoder#COMPRESSION_FORMAT}.
   */
  ...
  /**
   * Sets the value for key
   * {@link com.ststudy.client.android.utils.glide.load.resource.bitmap.BitmapEncoder#COMPRESSION_QUALITY}.
   */
  ...
  /**
   * Applies {@link com.ststudy.client.android.utils.glide.load.resource.bitmap.CenterCrop} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context Any {@link android.content.Context}.
   * @see #optionalTransform(Class, com.ststudy.client.android.utils.glide.load.Transformation)
   ...
   *
   * @param context Any {@link android.content.Context}.
   * @see #transform(Class, com.ststudy.client.android.utils.glide.load.Transformation)
  ...
  /**
   * Applies {@link com.ststudy.client.android.utils.glide.load.resource.bitmap.FitCenter} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
  ...
  /**
   * Applies {@link com.ststudy.client.android.utils.glide.load.resource.bitmap.CenterInside} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
  ...
  /**
   * Applies the given {@link com.ststudy.client.android.utils.glide.load.Transformation} for
   ...
   *
   * @param context        Any {@link android.content.Context}.
   * @param transformation Any {@link com.ststudy.client.android.utils.glide.load.Transformation} for
   *                       {@link android.graphics.Bitmap}s.
   * @see #optionalTransform(android.content.Context, com.ststudy.client.android.utils.glide.load.Transformation)
   * @see #optionalTransform(Class, com.ststudy.client.android.utils.glide.load.Transformation)
   */
   ...
   * {@link android.graphics.Bitmap Bitmaps} to the default types ({@link android.graphics.Bitmap},
   * {@link android.graphics.drawable.BitmapDrawable}, and
   * {@link com.ststudy.client.android.utils.glide.load.resource.gif.GifDrawable}) and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context        Any {@link android.content.Context}.
   * @param transformation Any {@link com.ststudy.client.android.utils.glide.load.Transformation} for
   *                       {@link android.graphics.Bitmap}s.
   * @see #transform(android.content.Context, com.ststudy.client.android.utils.glide.load.Transformation)
   * @see #transform(Class, com.ststudy.client.android.utils.glide.load.Transformation)
   */
  ...
  /**
   * Applies the given {@link com.ststudy.client.android.utils.glide.load.Transformation} for any decoded resource of
   ...
   * {@link com.ststudy.client.android.utils.glide.load.Transformation} for a resource type that already has a
   * {@link com.ststudy.client.android.utils.glide.load.Transformation} will override the previous call. </p>
   *
   ...
   * @param transformation The {@link com.ststudy.client.android.utils.glide.load.Transformation} to apply.
   */
  ...
  /**
   * Removes all applied {@link com.ststudy.client.android.utils.glide.load.Transformation Transformations} for all
   ...
   * {@link com.ststudy.client.android.utils.glide.TransitionOptions#dontTransition()}</p>
   */

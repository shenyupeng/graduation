 ...
 *
 * <p> A new instance is
 * created per resource load by {@link com.ststudy.client.android.utils.glide.load.model.ModelLoader}. {@link
 * #loadData(com.ststudy.client.android.utils.glide.Priority, com.bumptech.glide.load.data.DataFetcher.DataCallback)}
 ...
 * {@link #loadData(com.ststudy.client.android.utils.glide.Priority,
...
public interface DataFetcher<T> {
   ...
   * finally block after the data provided by {@link #loadData(com.ststudy.client.android.utils.glide.Priority,
   * com.bumptech.glide.load.data.DataFetcher.DataCallback)} has been decoded by the
   * {@link com.ststudy.client.android.utils.glide.load.ResourceDecoder}.
   *
   * <p> Note - this method will be run on a background thread so blocking I/O is safe. </p>
   */
  void cleanup();
  ...
  /**
   * Returns the {@link com.ststudy.client.android.utils.glide.load.DataSource} this fetcher will return data from.
   */

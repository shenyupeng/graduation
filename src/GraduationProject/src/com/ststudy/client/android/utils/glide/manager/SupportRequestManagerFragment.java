 ...
 * {@link com.ststudy.client.android.utils.glide.RequestManager} that can be used to start, stop and
 * manage Glide requests started for targets within the fragment or activity
 * this fragment is a child of.
 *
 * @see com.ststudy.client.android.utils.glide.manager.RequestManagerFragment
 * @see com.ststudy.client.android.utils.glide.manager.RequestManagerRetriever
 * @see com.ststudy.client.android.utils.glide.RequestManager
 */
public class SupportRequestManagerFragment extends Fragment {
	...
	/**
	 * Sets the current {@link com.ststudy.client.android.utils.glide.RequestManager}.
	 *
	...
	/**
	 * Returns the current {@link com.ststudy.client.android.utils.glide.RequestManager} or null if
	 * none is put.
	 */
	@Nullable
	...
	/**
	 * Returns the set of fragments that this RequestManagerFragment's parent is
	 * a parent to. (i.e. our parent is the fragment that we are annotating).
	 */
	...
	public void onLowMemory() {
		super.onLowMemory();
		// If an activity is re-created, onLowMemory may be called before a
		// manager is ever put.
		// See #329.
